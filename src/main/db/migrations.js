...
function seedQuickCommands(db) {
  ...
  const commands = [
    ...
    ['git add -A; git commit -m "{{input}}"',               'Stage all & commit with message'],
    ...
    ['git reset --hard {{input}}',                          'Hard reset to a specific commit hash'],
    ['git show {{input}}',                                  'Show details of a specific commit'],
    ['git diff {{input}} HEAD',                             'Diff from a specific commit to HEAD'],
    ['git checkout {{input}} -- .',                         'Restore files from a specific commit'],
    ['git checkout -- .',                                   'Discard all unstaged changes'],
    ['git clean -fd',                                       'Delete untracked files & folders'],
    // Branches
    ['git branch',                                          'List local branches'],
    ['git branch -a',                                       'List all branches (local + remote)'],
    ['git checkout {{input}}',                              'Switch to branch or commit'],
    ['git checkout -b {{input}}',                           'Create and switch to new branch'],
    ['git merge {{input}}',                                 'Merge a branch into current'],
    ['git branch -d {{input}}',                             'Delete a local branch'],
    ['git push origin --delete {{input}}',                  'Delete a remote branch'],
    // Remotes
    ...
    ['git tag {{input}}',                                   'Create a new tag'],
