  ...
  async _renderModelMapping() {
    ...
    const TIER_DETAILS = {
      ...
      heavyCode: {
        ...
        rows: [
          ['Claude',  'Sonnet 5 (CLI, preferred) — Opus 4.8 (CLI) for the hardest cases'],
    ...
    const sections = [
      {
        label: 'Pages',
        features: [
          { key: 'style-guide',     icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></svg>`, name: 'Styles',             note: 'Haiku, Flash Medium, Groq (Llama 8B)', tier: 'light', warning: '(Anthropic API direct call is better)' },
          { key: 'documents',       icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>`,                                                  name: 'Documents',          note: 'Haiku, Flash Medium, Groq (Llama 8B)', tier: 'light', warning: '(Anthropic API direct call is better)' },
          { key: 'project-layers',   icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>`,                                       name: 'Project Layers',     note: 'Haiku, Flash Medium, Groq (Llama 8B)', tier: 'light', warning: '(Anthropic API direct call is better)' },
          { key: 'mockups',         icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>`,                                                                               name: 'Mockups',             note: 'Sonnet, Flash High, Groq (Llama 70B)', tier: 'heavyGeneration', warning: '(Anthropic API direct call is better)' },
          ...
          { key: 'generate-workflows', icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/></svg>`, name: 'Generate Workflows', note: 'Sonnet, Flash High, Groq (Llama 70B)', tier: 'heavyGeneration', warning: '(Anthropic API direct call is better)' },
      ...
      },
      {
        label: 'Tools',
        features: [
          { key: 'ai-console',      icon: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`,                                                                                name: 'AI Chat',            note: 'Haiku, Flash Medium, Groq (Llama 8B)', tier: 'light', warning: '(Anthropic API direct call is better)' },
        ],
      },
    ];
